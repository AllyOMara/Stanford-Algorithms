...
## Solutions
### [Module 1 - MergeSort](https://github.com/AllyOMara/Stanford-Algorithms/blob/main/Part_1/Module_2_Assignment.py)<br>
...
### [Module 2 - Part 3: Optimised QuickSort](https://github.com/AllyOMara/Stanford-Algorithms/blob/main/Part_1/Module_3_Assignment_Part_3.py)<br>
...
Module 2 [Part 1](https://github.com/AllyOMara/Stanford-Algorithms/blob/main/Part_1/Module_3_Assignment_Part_1.py) and [Part 2](https://github.com/AllyOMara/Stanford-Algorithms/blob/main/Part_1/Module_3_Assignment_Part_2.py) are QuickSort where the pivot is the first and last element respectively.<br>
#### Key Implementations
