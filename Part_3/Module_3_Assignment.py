...
def calculate_is_weight(is_array, weights, optimal_is, max_node):
...
def max_weight_is():
    ...
    optimal_is = create_is_weights_list(MAX_RANGE)
    is_array = calculate_is_weight(is_weights, weights, optimal_is, 1)
