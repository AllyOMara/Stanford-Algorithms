'''
Stanford Algorithms - Course 1 Module 3
...
For the second part of the programming assignment, you should
always use the last element of the array as the pivot element.
'''
...
def quick_sort(array):
    ...
    pivot       = [array[len_array - 1]]
    array[last_index], array[0]  = array[0], array[last_index] # Swaps pivot element with the first element to mainatain consistency
