'''
Stanford Algorithms - Course 1 Module 2
...
def merge_and_count(array):
    ...
    while len(left) > 0 and len(right) > 0:
        if left[0] > right[0]:
            inverse_count = inverse_count + len(left)
...
file_name_2 = "even.txt"            # File with an even number integers. Has 7 inverses.
file_name_3 = "odd.txt"             # File with an odd number of integers. Has 6 inverses.
file_name_4 = "36_inv.txt"          # File with 36 inverses
file_name_5 = "2_inv.txt"           # File with 2 inverses
file_name_6 = "0_inv.txt"           # File with 0 inverses (i.e. sorted).
...
print(f"The number of inverses present in the file is: {inverse_count}.")
